...
const getProductById = (id) => {
  const products = [
    {
      ...
      stockCount: 15,
      description:
        "Crafted from soft cotton, this blue tee features a relaxed drop shoulder fit and an printed design on the front for a subtle artistic touch.",
      sizes: ["S","M","L","XL"],
        features: [
    ...
    category: "Drop-Shoulder",
    inStock: false,
    description: "Crafted from soft cotton, this beige tee features a relaxed drop shoulder fit and an printed design on the front for a subtle artistic touch.",
    sizes: ["S","M","L","XL"],
    features: [
      "Relaxed drop shoulder fit",
      "Printed design on the front",
  ...
  },
  {
    ...
    category: "Drop-Shoulder",
    inStock: true,
    description: "Crafted from soft cotton, this black tee features a relaxed drop shoulder fit and an printed design on the front for a subtle artistic touch.",
    sizes: ["XS","S","M","L","XL"],
    features: [
      "Relaxed drop shoulder fit",
      "Printed design on the front",
  ...
  },
  {
    ...
    category: "Drop-Shoulder",
    inStock: true,
    description: "Crafted from soft cotton, this white tee features a relaxed drop shoulder fit and an printed design on the front for a subtle artistic touch.",
    sizes: ["XS","S","M","L","XL"],
    features: [
      "Relaxed drop shoulder fit",
      "Printed design on the front",
  ...
  },
  {
    ...
    features: [
      "Vibrant citrus and energizing spicy notes",
      "Clean, dynamic feel",
      "Warm woody base",
      "Long-lasting performance",
      "Perfect for active, everyday wear",
      "Bold, confident vibe",
    ],
    specifications: {
      "Fragrance Type": "Sporty",
      "Top Notes": "Citrus, Spicy",
      "Base Notes": "Woody, Musk",
      "Longevity": "Long-lasting performance",
      "Sillage": "Bold, confident vibe",
    },
    volumes: {
