  ...
  return (
    <div className="bg-white text-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="max-w-4xl mx-auto text-sm text-gray-800 space-y-6">
          <section>
          ...
          <section>
            <h3 className="font-bold text-xl text-gray-800 mb-1">Information We Collect</h3>
          ...
          <section>
            <h3 className="font-bold text-xl text-gray-800 mb-1">How We Use Your Information</h3>
          ...
          <section>
            <h3 className="font-bold text-xl text-gray-800 mb-1">Data Protection & Security</h3>
            <p>
          ...
          <section>
            <h3 className="font-bold text-xl text-gray-800 mb-1">Cookies & Tracking Technologies</h3>
            <p>
          ...
          <section>
            <h3 className="font-bold text-xl text-gray-800 mb-1">Sharing of Information</h3>
            <p>
          ...
          <section>
            <h3 className="font-bold text-xl text-gray-800 mb-1">Your Rights</h3>
          ...
          <section>
            <h3 className="font-bold text-xl text-gray-800 mb-1">Changes to This Policy</h3>
            <p>
          ...
          <section>
            <h3 className="font-bold text-xl text-gray-800 mb-1">Contact Us</h3>
            ...
            <div className="mt-4 space-y-2 text-sm text-gray-800">
              ...
              <p className="flex items-center space-x-2">
                ...
                <span>Phone: <a href="tel:0339-2351135" className="font-semibold text-gray-800">0339-2351135</a></span>
              </p>
            </div>

            <p className="mt-6 text-sm text-gray-800">Thank you for trusting StyleWays!</p>
          </section>
        </div>
      </div>
    </div>
