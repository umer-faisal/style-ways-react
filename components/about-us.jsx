  ...
  return (
    <div className="bg-white text-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 text-center">
        <h1 className="text-2xl md:text-3xl font-semibold mb-2">We are StyeWays</h1>
        ...
        <div className="max-w-5xl mx-auto bg-[#e1e1e1] rounded-lg p-8 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex flex-col items-center text-center px-3">
              ...
              <h4 className="font-semibold text-sm">Trendsetting Selection</h4>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center py-6">
        <p className="max-w-4xl mx-auto text-gray-700 font-bold text-base md:text-lg">Join thousands of happy customers who trust StyleWays for their shopping needs. Browse our collections and experience the perfect blend of quality, convenience, and variety.</p>
        <a href="/products" className="inline-block mt-4 px-6 py-3 rounded-md font-semibold  text-gray-700 bg-transparent">Shop with us today!</a>
      </div>
